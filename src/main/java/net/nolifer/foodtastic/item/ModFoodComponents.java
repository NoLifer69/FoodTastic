...
public class ModFoodComponents {
    ...
    public static final FoodComponent BLUE_GRAPE = (new FoodComponent.Builder()).hunger(3).saturationModifier(0.2F).meat().build();
    public static final FoodComponent GREEN_GRAPE = (new FoodComponent.Builder()).hunger(3).saturationModifier(0.2F).meat().build();
}
